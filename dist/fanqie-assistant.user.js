...
(function () {
  ...
  var require_main_001 = __commonJS({
    "main-BS5h560h.js"(exports, module) {
      ...
      async function get$3(path, cookie, query, headers, optionsOverride) {
      ...
      async function getChapter(itemId, _retry) {
        ...
        const res = await get$3(`/reader/full/v1`, false, { item_id: itemId });
      ...
      function deprecateSimple(name2, msg) {
        if (hooks$1.deprecationHandler != null) {
          hooks$1.deprecationHandler(name2, msg);
        }
      ...
      async function getCatalog(bookId) {
        ...
        catalogRaw[0].map((item) => {
          const chapterItem = {
            ...
            title: item.title,
            // YYYY-MM-DD HH:mm:ss
            update_time: hooks$1(item.firstPassTime * 1e3).format("YYYY-MM-DD HH:mm:ss"),
      ...
      async function getBookInfo(bookId) {
        ...
        return {
          ...
          update_time: hooks$1(bookInfo.last_chapter_first_pass_time * 1e3).format("YYYY-MM-DD HH:mm:ss"),
      ...
      function formatReadingTime(readBookTime) {
        let minutes2 = readBookTime / 60000n;
        const hours2 = minutes2 / 60n;
        minutes2 = minutes2 % 60n;
        return `${hours2} 时 ${minutes2} 分`;
      }
      ...
      function filter(_path, _query, _hash) {
